...
val_word_seq = pickle.load(open(Config.cache_dir+"/val_word_han_seq_%s.pkl"%Config.word_seq_maxlen, "rb"))
val_char_seq = pickle.load(open(Config.cache_dir+"/val_char_han_seq_%s.pkl"%Config.char_seq_maxlen, "rb"))

batch_size = 64
model_name = "word_char_hcnn"
trainable_layer = ["word_embedding", "char_embedding"]
train_batch_generator = word_char_han_train_batch_generator
...
model = get_word_char_hcnn(Config.sentence_num, Config.sentence_word_length, Config.sentence_char_length, word_embed_weight, char_embed_weight)
